...
<div id="cb-main" class="ui segment cb-draft">
  <div class="cb-content">
    ...
    <div class="ui items cb-list cb-newList cb-newsList cb-draftList">
        ...
        <div class="item">
          <div class="image">
            <i data-id="<?php echo $model->id;?>" class="icon icon-deleteCompare cb-icon"></i>
    ...
    <a href="<?php echo Yii::app()->baseUrl.'/draft/publish?gid='.$gid;?>" class="ui button cb-btn huge">发布</a>
    <!--comment-->                
