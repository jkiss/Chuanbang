  ...
  <div class="ui grid cb-content" id="cb-brand">
    <div class="row cb-brand-logo">
      ...
      <div class="eight wide column cb-brand-info">
        <p><?php echo $star->summary;?></p>
      </div>
      <div class="center aligned four wide column cb-brand-notice">
        <p>
          <strong><?php echo $total_follows;?></strong>人<br>
          <a href="javascript:;" class="ui  huge button cb-btn cb-fav-star" data-id="<?php echo $star->id;?>" fav="<?php echo in_array($star->id, $my_star_ids)?'y':'n';?>">
              <span class="description <?php echo in_array($star->id, $my_star_ids) ? 'hide' : '';?>">关注</span>
              <span class="description <?php echo !in_array($star->id, $my_star_ids) ? 'hide' : '';?>">取消关注</span>
          </a>
        </p>
      </div>
    </div><!--品牌关注--> 
