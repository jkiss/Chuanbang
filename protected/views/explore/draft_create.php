...
<div id="cb-main" class="ui segment center aligned cb-draft cb-draft1">
  <form id="form-draft" action="/draft/create" method="post">
  <p>把照片拖放到这里或</p>
  <div id="cb-upLoad" class="item ui icon huge button cb-btn cb-upload">
    <i class="icon cb-icon icon-uploadphoto"></i>
    选择照片文件
  </div>
  <p class="cb-notice">*一次最多上传8张照片<br>链接到 draft2.html</p>
      <div class="cb-uploads"></div>
  </form>
