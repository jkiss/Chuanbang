...
<div class="cb-answerPic">
    ...
    <div id="cb-bigPic">
        <ul id="thumbnails">
            ...
            <li><img src="<?php echo $pic->img;?>"></li>
            <?php endforeach;?>
        </ul>
...
<div class="cb-answerTitle clearfix">
    ...
    <div class="content">
        ...
        <div class="ui horizontal list cb-answerInfo">
            <div class="item"><?php echo $times[0];?>年<?php echo $times[1];?>月<?php echo $times[2];?>日</div>
...
<!--addAnswer-->
    ...
    <!-- 评论 -->
    <div class="ui fluid accordion cb-comment">
        <div class="ui segment title active">
            <div class="ui right floated tiny header"><i class="angle up icon"></i> <span>收起</span></div>
            <div class="ui left floated tiny header"><i class="cb-icon icon icon-comment"></i>讨论区</div>
        </div>
        <div class="active content">
            <div class="ui comments">
                ...
                <div class="comment">
                    <a class="avatar">
                        <img src="<?php echo $comment->author->head;?>">
                    </a>
                    <div class="content">
                        <a class="author"><?php echo $comment->content;?></a>
                        <div class="text">
                            <?php echo $comment->author->nick;?>•<?php echo date('Y-m-d', $comment->createtime);?>
                        </div>
                    </div>
                </div>
                <?php endforeach;?>

                <form class="ui comment reply form">
                    <a class="avatar">
                        <img src="brand/img/3.png">
                    </a>
                    <div class="content clearfix">
                        <textarea class="cb-commentText"></textarea>
                        <div class="text">
                            用户登录后的名字•2014-01-20
                        </div>
                        <a href="" class="ui right floated button cb-btn huge">提交</a>
                    </div>
                </form>
                <!--comment-->
            </div>
...
<div class="ui label cb-addCompare" id="cb-showCompare">
    <i class="icon cb-icon icon-compare"></i>20
</div>
<div id="cb-compare" class="ui column sidebar right cb-sidebar cb-sidebar-right">
    ...
    <div class="ui segment attached">
        <div class="ui selection list">
            ...
            <a class="item cb-item" href="">
                <div class="ui image left floated">
                    <i class="icon icon-deleteCompare cb-icon"></i>
                    <img src="/page/explore/brand/img/8.png" data-pinit="registered">
                </div>
                <div class="content" href="">
                    <p class="description">米兰达·可儿穿着GUCCI 2014春夏</p>
                </div>
            </a>
        ...
        <a href="" class="ui huge button cb-btn">开始比较</a>
    </div>
</div><!--add-compare-->
</div>
