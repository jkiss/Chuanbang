...
<div id="cb-main" class="ui segment cb-index cb-explore">
  <div class="cb-content">
      <!--话题-->
      <?php if(isset($latest_topics)):?>
          <?php echo $this->renderPartial('latest_topics', array('latest_topics'=>$latest_topics,)); ?>
      <?php endif;?>

    <div class="ui tiny header">
      <a href="compare/index.html" class="cb-more"><i class="icon-more cb-icon icon"></i> 更多</a>
    <i class="icon cb-icon icon-compare"></i>
    对比</div>
    <div class="ui two connected items cb-list cb-newList cb-newsList cb-comList">
      <div class="row">
        
        <a class="item cb-itemHover" href="/page/explore/compare/compare.html">
          <div class="image">
            <img src="/page/explore/brand/img/new-11.jpg" data-pinit="registered">
          </div>
          <div class="image">
            <img src="/page/explore/brand/img/new-1.jpg" data-pinit="registered">
          </div>
          <div class="content">
            <h3 class="description">贝克汉姆身着爱马士</h3>
          </div>
        </a>
        
        <a class="item cb-itemHover" href="/page/explore/compare/compare.html">
          <div class="image">
            <img src="/page/explore/brand/img/new-12.jpg" data-pinit="registered">
          </div>
          <div class="image">
            <img src="/page/explore/brand/img/new-2.jpg" data-pinit="registered">
          </div>
          <div class="content">
            <h3 class="description">贝克汉姆身着爱马士</h3>
          </div>
      ...
      <!--待答-->
      <?php if(isset($pending_questions)):?>
          <?php echo $this->renderPartial('pending_questions', array('pending_questions'=>$pending_questions,)); ?>
      <?php endif;?>
