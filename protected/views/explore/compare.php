<script type="text/javascript">
    var page="compare-explore";
</script>
<div id="cb-main" class="ui segment cb-compare">
<div class="cb-content">
    <div class="row">
        <div class="ui two connected items cb-list cb-newList cb-newsList cb-comList">
            <?php for($i=0, $len=count($compares); $i < $len; $i = $i+4):?>
            <div class="row">

                <a class="item cb-itemHover" href="javascript:;">
                    <div class="image">
                        <img src="<?php echo $compares[$i]['img'];?>" data-pinit="registered">
                    </div>
                    <div class="image">
                        <?php if(($i+1 < $len) && $compares[$i]['id'] == $compares[$i+1]['id']):?>
                        <img src="<?php echo $compares[$i+1]['img'];?>" data-pinit="registered">
                        <?php endif;?>
                    </div>
                    <div class="content">
                        <h3 class="description"><?php echo $compares[$i]['title'];?></h3>
                    </div>
                </a>
                ...
                <a class="item cb-itemHover" href="javascript:;">
                    <div class="image">
                        <img src="<?php echo $compares[$i+2]['img'];?>" data-pinit="registered">
                    </div>
                    <div class="image">
                        <?php if(($i+3 < $len) && $compares[$i+2]['id'] == $compares[$i+3]['id']):?>
                            <img src="<?php echo $compares[$i+3]['img'];?>" data-pinit="registered">
                        <?php endif;?>
                    </div>
                    <div class="content">
                        <h3 class="description"><?php echo $compares[$i+2]['title'];?></h3>
                    </div>
                </a>
                <?php endif;?>
