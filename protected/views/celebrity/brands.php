...
<section class="content" id="b_s_brand">
    ...
    <div id="page_panel" data-max-page="<?php echo $total_page;?>">
        <?php for($i = 0, $len = count($brands); $i < $len;$i += 2):?>
        <ul class="one">
            <li>
                <div class="img-wrap">
                    <a href="<?php echo Yii::app()->createUrl('brand/view',array('id'=>$brands[$i]['id']));?>"><img src="<?php echo $brands[$i]['logo'];?>?w=130&h=130" alt=""></a>
                </div>
                <p class="cn"><?php echo $brands[$i]['name_cn'];?></p>
                <p class="en"><?php echo $brands[$i]['name_en'];?></p>
                <div class="m-data"><?php echo $brands[$i]['total_qa'];?>身穿搭／<?php echo $brands[$i]['total_fans'];?>粉丝</div>
            </li>
            <?php if($i + 1 <= $len -1):?>
                <li>
                    <div class="img-wrap">
                        <a href="<?php echo Yii::app()->createUrl('brand/view',array('id'=>$brands[$i+1]['id']));?>"><img src="<?php echo $brands[$i+1]['logo'];?>?w=130&h=130" alt=""></a>
                    </div>
                    <p class="cn"><?php echo $brands[$i+1]['name_cn'];?></p>
                    <p class="en"><?php echo $brands[$i+1]['name_en'];?></p>
                    <div class="m-data"><?php echo $brands[$i+1]['total_qa'];?>身穿搭／<?php echo $brands[$i+1]['total_fans'];?>粉丝</div>
                </li>
            <?php endif;?>
        </ul>
        <?php endfor;?>
                ...
                for (var i = 0; i < data.length; i++) {
                    if(i % 2 === 0){
                        if(i === 0){
                            ...
                            content += '<li><div class="img-wrap"><a href="/brand/'+ data[i].id +'"><img src="'+ data[i].logo +'?w=130&h=130" alt=""></a></div><p class="cn">'+ data[i].name_cn +'</p><p class="en">'+ data[i].name_en +'</p><div class="m-data">'+ data[i].total_qa +'身穿搭／'+ data[i].total_fans +'粉丝</div></li>';
                        }else{
