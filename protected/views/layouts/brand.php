        ...
        <div class="sub-nav">
            <ul id="b_s_sub">
                <?php if($this->action->id == 'view'):?>
                    <a href="<?php echo Yii::app()->createUrl('brand/index');?>">
                        <li <?php echo $this->action->id == 'view' ? 'class="active home transition"' : 'class="home transition"';?>>主页</li>
                    </a>
                <?php else:?>
                    <a href="<?php echo Yii::app()->createUrl('brand/view', array('id'=>$this->model['id']));?>">
                        <div class="thumb transition">
                            <div class="img-wrap">
                                <img src="<?php echo $this->model['logo'];?>" alt="">
                            </div>
                            <p><em>
                ...
                <?php endif;?>
                <a href="<?php echo Yii::app()->createUrl('brand/products', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'products' ? 'class="active transition"' : 'class="transition"';?>>秀场</li>
                </a>
                <a href="<?php echo Yii::app()->createUrl('brand/designer', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'designer' ? 'class="active transition"' : 'class="transition"';?>>设计师</li>
                </a>
                <a href="<?php echo Yii::app()->createUrl('brand/fresh', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'fresh' ? 'class="active transition"' : 'class="transition"';?>>品牌动态</li>
                </a>
                <a href="<?php echo Yii::app()->createUrl('brand/celebrity', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'celebrity' ? 'class="active transition"' : 'class="transition"';?>>相关名人</li>
                </a>
                <a href="<?php echo Yii::app()->createUrl('brand/topic', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'topic' ? 'class="active transition"' : 'class="transition"';?>>去过活动</li>
                </a>
                <a href="<?php echo Yii::app()->createUrl('brand/fan', array('id'=>$this->actionParams['id']));?>">
                    <li <?php echo $this->action->id == 'fan' ? 'class="active transition"' : 'class="transition"';?>>粉丝</li>
                </a>
            </ul>
        </div>
    </div>
