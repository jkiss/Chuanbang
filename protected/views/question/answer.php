...
<div class="sub-nav-wrap">
    <div class="sub-nav">
        <nav class="items answer-sub">
            <ul class="wheel-panel a-w-p">
                <h3>相关品牌</h3>
                <div class="brand">
                    <?php foreach($brands as $brand):?>
                    <li class="one transition"><a href="<?php echo Yii::app()->createUrl('brand/view',array('id'=>$brand['id']));?>">
                        <div class="img-wrap">
                            <img src="<?php echo $brand['logo'];?>?w=85&h=85" alt="">
                        </div>
                        <p class="name"><em>
                            <?php echo $brand['name_cn'];?><br>
                            <?php echo $brand['name_en'];?>
                        </em></p>
                        <p class="follow-num">
                            <?php echo $brand['follows'];?>人关注
                        </p>
                    </a></li>
                    <?php endforeach;?>
                </div>
                ...
                <div class="star">
                    ...
                    <li class="one transition"><a href="<?php echo Yii::app()->createUrl('celebrity/view',array('id'=>$cele['id']));?>">
                        <div class="img-wrap">
                            <img src="<?php echo $cele['head'];?>?w=85&h=85" alt="">
                        </div>
                        <p class="name"><em>
                ...
                <div class="topic">
                    ...
                    <li class="transition t-one"><a href="<?php echo Yii::app()->createUrl('topic/view',array('id'=>$topic['id']));?>">
                        <div class="t-img-wrap">
                            <img src="<?php echo $topic['cover'];?>?w=175&h=115" alt="">
                        </div>
                        <p class="title text-overflow"><?php echo $topic['title'];?></p>
                    </a></li>
                    <?php endforeach;?>
                </div>
                <?php endif;?>
...
<!-- Wait detail content -->
<section class="content" id="answer" data-ques-id="">
    ...
    <div class="most-hot">
        ...
        <div class="top-label">最热答案</div>
        <?php endif;?>

        <?php foreach($answer['celebrities'] as $cele):?>
        <p class="clothes">
            <span class="star-name">
                <?php echo $cele['name'];?>
                <i class="icon-in"></i>
            </span>
            <?php for($i = 0,$len = count($cele['attaches']); $i < $len; $i++):?>
            <span class="brand-name"><?php echo $cele['attaches'][$i]['brand_name'];?></span>
            <span class="type"><?php echo $cele['attaches'][$i]['clothes_type'];?></span>
            <span class="style"><?php echo $cele['attaches'][$i]['style'];?></span><?php if($i != $len - 1):?>,<?php endif;?>
            <?php endfor;?>
        </p>
        <?php endforeach;?>
        ...
        <div class="gray-box">
            ...
            <div class="img-box clearfix show-mode1">
                <div id="thumb_box">
                    <div class="imgs-box">
                        <ul class="imgs-abs-wrap">
                            <?php $iter = 0;?>
                            <?php foreach($question['imgs'] as $img):?>
                            <li <?php echo $iter++ == 0 ? 'class="on"' : '';?>>
                                <img src="<?php echo $img['url'];?>" data-support="<?php echo $img['support'];?>" data-url="<?php echo $img['url'];?>">
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                ...
                <div class="slider-box">
                    <ul id="slider_box">
                        <?php $iter = 0;?>
                        <?php foreach($question['imgs'] as $img):?>
                            <li <?php echo $iter++ == 0 ? 'class="s-on"' : '';?>>
                                <img src="<?php echo $img['url'];?>" data-support="<?php echo $img['support'];?>">
                            </li>
                        <?php endforeach;?>
                    </ul>
            ...
            <div class="author">
                ...
                <p class="time"><?php echo $answer['time'];?></p>
                <div class="comment-num">全部评论 <?php echo $answer['total_comments'];?></div>
            </div>
        </div>
        <?php if(isset($answer['happens'])):?>
        <div class="event">
            <p class="title"><?php echo $answer['happens'];?></p>
            <p class="m-data"><?php echo $answer['occurdate'];?> <?php echo $answer['place'];?></p>
        </div>
        <?php endif;?>
        <?php if(!empty($answer['imgs'])):?>
        <div class="about-img clearfix">
            <p class="title">相关图片</p>
            <?php foreach($answer['imgs'] as $img):?>
            <img src="<?php echo $img;?>" alt="">
            <?php endforeach;?>
        </div>
        <?php endif;?>
        <?php if(isset($answer['content'])):?>
        <div class="critic-say">
            <i data-svg="icon-quote-left"></i>
            <?php echo $answer['content'];?>
            <i data-svg="icon-quote-right"></i>
        </div>
        <?php endif;?>
        <div class="profile">
            <span class="collect">
                <i class="icon-collect-1"></i>
                收藏<?php echo $answer['total_follows'];?>
            </span>
            <span class="zan">
                <i class="icon-zan-1"></i>
                赞<?php echo $answer['total_supports'];?>
            </span>
            <span class="share">
    ...
    <?php if($question['total_answers'] > 1):?>
    <div class="other-ans">
        <p class='title'>
            其他精彩解读
            <span class="ans-num">共<?php echo $question['total_answers']-1;?>条</span>
        </p>
        <ul class="ans-box">
            ...
            <li>
                <div class="critic">
                    <div class="img-wrap">
                        <img src="<?php echo $item['author']['head'];?>" alt="">
                    </div>
                    <p class="name"><?php echo $item['author']['nick'];?></p>
                    <p class="time"><?php echo $item['time'];?></p>
                </div>
                <?php foreach($item['celebrities'] as $cele):?>
                <h1 class="star-name"><?php echo $cele['name'];?></h1>
                <p class="clothes">
                    <i class="icon-in"></i>
                    <?php for($i = 0,$len = count($cele['attaches']); $i < $len; $i++):?>
                        <span class="brand-name"><?php echo $cele['attaches'][$i]['brand_name'];?></span>
                ...
                <div class="thr-ctrl">
                    <span class="collect">
                        <i class="icon-collect-1"></i>
                        收藏<?php echo $item['total_follows'];?>
                    </span>
                    <span class="zan">
                        <i class="icon-zan-1"></i>
                        赞<?php echo $item['total_supports'];?>
                    </span>
                    <span class="share">
                        <i class="icon-share-1"></i>
                        分享
                    ...
                    <span class="comment-num">
                        评论<?php echo $item['total_comments'];?>
                    </span>
                </div>
            </li>
            <?php endforeach;?>
            <div class="more-ans">
                <span class="m-a-btn transition">查看更多解答</span>
            </div>
        </ul>
    </div>
    <?php endif;?>
    <div class="submit-answer">我来解答</div>
...
<div id="big_photo">
    ...
    <ul class="ctrl-panel">
        <li class="compare"><i class="icon-compare"></i><br>对比</li>
    ...
    <div class="pop-box clearfix">
        <div class="scroll-wrap">
            ...
            <div class="scroll-panel">
                ...
                <div class="left">
                    <img class="pop-ava" src="../images/wait/pop_ava1.jpg" alt="Pop_avatar">
                    <p class="name text-overflow">Usernamy</p>
                </div>
                <div class="right form-info clearfix">
                    ...
                    <ul class="f-box no-select">
                        <li id="p1" class="p-one clearfix">
                            <div class="l-person">
                                <input type="text" name="p1" placeholder="刘德华" />
                                <div id="add_person" style="display:none;">+</div>
                            </div>
                            <ul class="r-wear">
                                <li class="w-one" id="w1">
                                    <input type="text" name="clothes" class="clothes" placeholder="普拉达">
                                    ...
                                    <i class="w-cancel icon-cancel"></i>
                                </li>
                                <div class="add-wear"  style="display:none;">+</div>
                            </ul>
                        </li>
                    </ul>
                    <!-- 添加事件 -->
...
function invokeHere(Pagination, publishDate, Wheel){
    ...
    var 
        wheel_opt = {
            able_w_h: $('.a-w-p')[0].offsetHeight - $('.sub-nav')[0].offsetHeight + 20,
            w_dis: 200,
            w_panel: $('.a-w-p'),
            origin_top: parseInt($('.a-w-p').css('top')),
            time: 200
        },
    ...
    $(function(){
        ...
        c_f.addAImg = function(src, id, callback){
            var _me = $('.compare-fix'),
                ul = _me.find('ul'),
            ...
            $.ajax({
                ...
                success: function(data, status, xhr){
                    ...
                    if(data.ret === 0){
                        // 添加对比的新图片的动画
                        ul.prepend($('<li><i class="com-cancel icon-cancel"></i><img class="new-one" src="' + src + '" data-id="'+ id +'" alt="#"></li>'));
        ...
        $('.img-box li.compare').click(function(event) {
            var fly_img = $('li.s-on').find('img')[0],     // 需要飞的图片
            ...
            if(c_f.find('img').length < 9 && fly_end && !c_f.contain(fly_img.src)){
                ...
                // 开始飞图
                fly_end = false;
                var $airplane = $('<div id="airplane"></div>').appendTo('body'),  // 搭载图片飞行的DOM
                    target = $('div.compare-fix')[0].getBoundingClientRect();     // 飞行的目的地
                ...
                $.flyTo($airplane, target.left, target.top + 50, function(){
                    c_f.addAImg(src, fly_img_id, function(){
                        fly_end = true;
                    });
                });
            }
            ...
            for(var i = 0; i < _files.length; i++){
                if(pop_added_imgs.length < 9){
                    if(!pop_added_imgs.contain(_files[i])){
                        ...
                        console.log(pop_added_imgs, pop_added_imgs.length);
                        
                        // detectScroll();    // 检测是否需要滚动
                    }else{
                        console.log('这张图片已经添加了哦。。。');
                    }
                }else{
                    console.log('超过9张图片了。。。');
                    return false;
        ...
        $('#sub_btn').click(function(event) {
            ...
            // Form 问题 id
            fd.append('Answer[ques_id]', question_id);
            // Form 人物穿着
