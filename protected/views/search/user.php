    ...
    var extra_data = {
        ...
        updateContent = function(data, page_panel){  // 请求 success 后，更新页面内容
            ...
            for (var i = 0; i < data.length; i++) {
                content += '<a href="'+ data[i].href +'" class="column float"><div class="image s-scale"><img src="'+ data[i].head +'" alt="#"></div><div class="caption"><p class="name text-overflow">'+ data[i].nick +'</p><p class="fans text-overflow">{{粉丝数}}</p></div></a>';
            };
