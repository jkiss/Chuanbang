...
<section class="content" id="b_s_new">
    ...
    <div id="page_panel" data-max-page="<?php echo $total_page;?>">
        ...
        <div class="one">
            <div class="img-wrap">
                <a href="<?php echo Yii::app()->createUrl('brand/view',array('id'=>$answer['id']));?>">
            ...
            <div class="clothes cele">
                <span class="celebrity">
                    <?php echo $detail['celebrity'];?>
                    <i class="icon-in"></i>
                </span>
                <span class="type"><?php echo $detail['style'];?></span>
                <span class="style"><?php echo $detail['clothes_type'];?></span>
            </div>
            <?php endforeach;?>
            <div class="event">
            ...
            <div class="m-data">
                <div class="detail">
                    ...
                    <span><?php echo max(1,intval($answer['total_answers'])-1);?>条其他解读</span>
                </div>
                <div class="author">
                    <div class="avatar">
                        <img src="<?php echo $answer['author']['head'];?>?w=35&h=35" alt="">
                    </div>
