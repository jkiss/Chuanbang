    ...
    <div class="sub-nav">
        <nav class="items index-sub">
            ...
            <ul class="wheel-panel">
                <?php foreach($trend as $brand):?>
                    <li class="transition">
                        <a href="<?php echo Yii::app()->createUrl('brand/view',array('id'=>$brand['id']));?>">
                            <div class="img-wrap">
                                <img src="<?php echo $brand['logo'];?>?w=80&h=80" alt="#">
                            </div>
                            <p><em>
    ...
    <div class="c-top">
        <div class="grid two sep-1 clearfix" id="page_panel">
            ...
            <i class="column float transition pos-r mb-30">
                <div class="profile">
                    <a href="<?php echo Yii::app()->createUrl('brand/'.$model['id']);?>">
                        <div class="img-wrap">
                            <img src="<?php echo $model['logo'];?>?w=120&h=120" alt="ava">
                        </div>
                    </a>
                ...
                <div class="relate">
                    <div class="grid two sep clearfix">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('answer/'.$data['id']);?>" class="column float transition">
                            ...
                            <div class="bottom">
                                <div class="title">
                                    <p class="t_name text-overflow"><?php echo $data['celebrity'];?></p>
                                    <i class="icon-in"></i>
                                    <p class="t_clothes">
                                        <?php echo $model['name'];?>
                                    </p>
    ...
    <div class="c-bottom">
        ...
        <div class="grid six sep clearfix">
            <?php foreach($more as $model):?>
                <a href="<?php echo Yii::app()->createUrl('brand/'.$model['id']);?>" class="column float transition">
                    <div class="image scale-2">
                        <img class="transition" src="<?php echo $model['logo'];?>?w=196&h=196" alt="more-star">
                    </div>
